  ...
  return (
    <div className="HomePage">
      <div className="navbar">
        <img className="aruci--logo" src={Logo} alt="ARUCI Logo" />
        <div className="buttons">
          <button className="button" onClick={() => alert('Navigate to Employee Portal')}>
            Employee Portal
          </button>
          <button className="button" onClick={() => alert('Navigate to Customer Portal')}>
            Customer Portal
          </button>
        </div>
      </div>
      ...
      <div className="Body">
        <img className="BankPhoto" src={BankPhoto} alt="Bank Overview" />
        <div className="paras">
          <div className="twoparas">
            <div className="para">
              ...
              <p>
                ...
                exclusive Premier banking experience, with personalized
          ...
          <div className="twoparas">
            ...
            <div className="para">
              ...
              <p>
                ...
                talent, your pocket money, and cash gifts in an ARUCI Teen
                Account.
              </p>
            </div>
          </div>
